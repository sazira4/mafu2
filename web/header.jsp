            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/trMSystem/Home.jsp"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                        </li>
                        <li>
                    ...
                    <li>
                        <a href="/trMSystem/sendAdvertisement.jsp"><i class="fa fa-fw fa-desktop"></i> Send Advertisement</a>
                    </li>
                    <li>
                        <a href="/trMSystem/certificate.jsp"><i class="fa fa-fw fa-wrench"></i> Certificate</a>
                    </li>
                    
                    <li>
                        <a href="/trMsystem/report.jsp"><i class="fa fa-fw fa-file"></i> Report</a>
                    </li>>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
