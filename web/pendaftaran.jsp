<%-- 
    ...
    Created on : Dec 18, 2014, 9:22:38 PM
    Author     : Hafizah
--%>
...
<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form class="form-horizontal" name="status" id="status" method="get" action="pendaftaran.jsp">
...
<%
   ...
   try {
        ...
        String queryString = "UPDATE penyertaan SET status=? WHERE idPenyertaan= '" + id + "'";
