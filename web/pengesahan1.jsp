<%-- 
    Document   : pengesahan1
    Created on : Dec 19, 2014, 8:42:08 AM
    Author     : Hafizah
--%>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">List Course Application</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
%>
			...
			<td><%= rs.getString("courseCode") %></td>
		        ...
		        <td><%= rs.getString("category") %></td>
                        ...
                        <td><a href='pendaftaran1.jsp?courseID=<%= rs.getString("courseCode")%>'>View Application</a></td>
